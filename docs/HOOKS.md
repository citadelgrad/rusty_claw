...
- [Example: hooks_guardrails.rs](../examples/hooks_guardrails.rs) -- HookHandler validation and logging
- [Example: hook_callbacks.rs](../examples/hook_callbacks.rs) -- HookCallback trait, HookInput/HookContext/HookResponse
